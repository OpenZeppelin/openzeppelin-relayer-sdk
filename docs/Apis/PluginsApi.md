...
|------------- | ------------- | -------------|
| [**callPlugin**](PluginsApi.md#callPlugin) | **POST** /api/v1/plugins/{plugin_id}/call{route} | Execute a plugin with optional wildcard route routing |
| [**callPluginGet**](PluginsApi.md#callPluginGet) | **GET** /api/v1/plugins/{plugin_id}/call{route} | Execute a plugin via GET (must be enabled per plugin) |
| [**listPlugins**](PluginsApi.md#listPlugins) | **GET** /api/v1/plugins | List plugins. |


<a name="callPlugin"></a>
# **callPlugin**
> ApiResponse_Value callPlugin(plugin\_id, route, PluginCallRequest)
...
| **route** | **String**| Optional route suffix captured by the server. Use an empty string for the default route, or include a leading slash (e.g. &#39;/verify&#39;). May include additional slashes for nested routes (e.g. &#39;/api/v1/action&#39;). | [default to null] |
...
|------------- | ------------- | ------------- | -------------|
| **plugin\_id** | **String**| The unique identifier of the plugin | [default to null] |
| **route** | **String**| Optional route suffix captured by the server. Use an empty string for the default route, or include a leading slash (e.g. &#39;/supported&#39;). May include additional slashes for nested routes. | [default to null] |
