# JsonRpcResponse_NetworkRpcResult_result
## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **conversion\_rate** | **String** | Conversion rate from XLM to token (as string) | [default to null] |
| **estimated\_fee** | **String** | Estimated fee in token amount (as string for precision) | [default to null] |
...
| **fee\_in\_token** | **String** | Fee amount in token (as string) | [default to null] |
