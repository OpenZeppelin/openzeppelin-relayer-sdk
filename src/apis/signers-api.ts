...
export const SignersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateSigner: async (signerId: string, requestBody: { [key: string]: any; }, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'signerId' is not null or undefined
...
export const SignersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updateSigner(signerId: string, requestBody: { [key: string]: any; }, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseSignerResponse>> {
...
export const SignersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateSigner(signerId: string, requestBody: { [key: string]: any; }, options?: RawAxiosRequestConfig): AxiosPromise<ApiResponseSignerResponse> {
...
export class SignersApi extends BaseAPI {
     ...
     * @memberof SignersApi
     */
    public updateSigner(signerId: string, requestBody: { [key: string]: any; }, options?: RawAxiosRequestConfig) {
