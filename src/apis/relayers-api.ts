...
export const RelayersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        quoteSponsoredTransaction: async (relayerId: string, sponsoredTransactionQuoteRequest: SponsoredTransactionQuoteRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'relayerId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        signTransaction: async (relayerId: string, signTransactionRequest: SignTransactionRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'relayerId' is not null or undefined
...
export const RelayersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async quoteSponsoredTransaction(relayerId: string, sponsoredTransactionQuoteRequest: SponsoredTransactionQuoteRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseSponsoredTransactionQuoteResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.quoteSponsoredTransaction(relayerId, sponsoredTransactionQuoteRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RelayersApi.quoteSponsoredTransaction']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async signTransaction(relayerId: string, signTransactionRequest: SignTransactionRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseSignTransactionResponse>> {
...
export class RelayersApi extends BaseAPI {
     ...
     * @memberof RelayersApi
     */
    public quoteSponsoredTransaction(relayerId: string, sponsoredTransactionQuoteRequest: SponsoredTransactionQuoteRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof RelayersApi
     */
    public signTransaction(relayerId: string, signTransactionRequest: SignTransactionRequest, options?: RawAxiosRequestConfig) {
